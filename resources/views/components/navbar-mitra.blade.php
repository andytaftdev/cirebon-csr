...
<!-- JavaScript for toggling notifications -->
<script>
    ...
    document.addEventListener('click', function (event) {
        var dropdown = document.getElementById('notification-dropdown-mobile');
        var notificationIconMobile = document.getElementById('notification-icon-mobile');
        if (!notificationIconMobile.contains(event.target) && !dropdown.contains(event.target)) {
            dropdown.classList.add('hidden');
        }
    });
