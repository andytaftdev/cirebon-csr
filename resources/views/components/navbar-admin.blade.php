    ...
    <div class="container mx-auto flex justify-between items-center p-4 bg-white">
        ...
        <div class="flex items-center">
            <a class="w-auto h-auto" href="#">
                <p class="mt-1 mb-1 mr-8 text-Ebony900 font-medium">Dashboard</p>
            </a>
            <a class="w-auto h-auto" href="#">
                <p class="mt-1 mb-1 mr-8 text-Ebony900 font-medium">Kegiatan</p>
            </a>
            <a class="w-auto h-auto" href="#">
                <p class="mt-1 mb-1 mr-8 text-Ebony900 font-medium">Proyek</p>
            </a>
            <a class="w-auto h-auto" href="#">
                <p class="mt-1 mb-1 mr-8 text-Ebony900 font-medium">Sektor</p>
            </a>
            <a class="w-auto h-auto" href="{{route('laporan.index')}}">
                <p class="mt-1 mb-1 mr-8 text-Ebony900 font-medium">Laporan</p>
            </a>
            <a class="w-auto h-auto" href="#">
                <p class="mt-1 mb-1 mr-8 text-Ebony900 font-medium">Mitra</p>
            </a>
        </div>
        <div class="flex items-center">
            <div class="text-right mr-4">
                <p class="font-medium text-Ebony900">{{$identity->nama_mitra}}</p>
                <p class="text-sm text-Ebony100">{{Auth::user()->level}}</p>
            </div>
            <a href="{{route('identity.index')}}">
            <div class="relative">
                <img src="{{ asset('images/user.jpeg') }}" alt="User Avatar" class="h-9 w-9 rounded-full border border-Neutral300">
            </div>
            </a>
