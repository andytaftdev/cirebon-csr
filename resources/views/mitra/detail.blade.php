...
<div class="flex flex-col w-full min-h-screen bg-gray-100">
    ...
    <div class="flex-grow p-7 mx-auto w-full max-w-screen-2xl h-full">
        <div class="flex items-center space-x-2 mb-4">
            <a href="#" class="flex items-center text-Ebony300">
            ...
            <span class="text-sm font-medium text-Ebony300 px-2 py-1 rounded-md">Mitra</span>
            <a class="flex items-center text-Ebony300">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                    stroke="currentColor" class="w-5 h-5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mt-10 space-y-4 md:space-y-0">
            <h1 class="text-2xl text-left text-Ebony900 my-0">Profil Mitra</h1>
            <div class="flex gap-4">
                <a href="{{ route('identity.ubahMitra', $identity->id) }}">
                <button
                    class="bg-AccentRed900 text-white text-sm flex justify-center items-center px-5 py-3 rounded-lg gap-2">
                ...
                @else
                <button
                    class="text-AccentRed900 bg-white text-sm border border-AccentRed900 flex justify-center items-center px-5 py-3 rounded-lg gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.2"
                        stroke="currentColor" class="w-5 h-5">
                        <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div
            ...
            <div class="flex justify-center flex-col items-center w-full md:w-1/3 mb-6 md:mb-0 relative">
            ...
            <div class="flex flex-col items-start w-full md:w-1/2">
                <div class="space-y-1 mb-4">
                    <div class="flex justify-center items-center gap-3">
                        ...
                        @if($identity->user->email_verified_at === null)
                        <span class="px-2 p-1 inline-flex text-xs font-semibold rounded-full bg-Yellow100 text-AccentRed300">
                            Pengajuan
                        </span>
                        @else
                        <span class="px-2 p-1 inline-flex text-xs font-semibold rounded-full bg-Green50 text-Green600">
                            Terverifikasi
                        </span>
                        @endif
                    </div>
                ...
                <div class="space-y-3">
                    <div class="flex items-center space-x-0">
                        ...
                        <p class="text-sm text-Ebony300">{{$identity->user->email}}</p>
                    </div>
                    <div class="flex items-center space-x-0">
                        <div
                            class="w-10 h-10 bg-AccentRed100 rounded-full flex items-center justify-center mr-4 cursor-pointer">
                ...
                <p class="text-sm text-Ebony300 leading-relaxed mt-4">
                {{$identity->deskripsi}}
                </p>
            </div>
        </div>
    ...
    <div id="deactivateModal" class="fixed inset-0 bg-gray-950 bg-opacity-[95%] hidden z-40 flex justify-center items-center">
        <!-- Modal -->
        <div class="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <div class="flex justify-start items-start flex-col">
                <div class="w-12 h-12 bg-Blue50 rounded-full flex items-center justify-center">
                    <div class="bg-Blue102 w-10 h-10 rounded-full flex justify-center items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="size-6 text-Blue">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 3.75h.008v.008H12v-.008Z" />
                        </svg>                          
                    </div>
                </div>
                <h2 class="text-xl font-bold Ebony900 mt-3 mb-1">Non-Aktifkan Mitra?</h2>
                <button id="closeModal"></button>
                <p class="text-Ebony200 mb-4">Mitra akan dinonaktifkan sementara, anda bisa mengaktifkan kembali setelahnya
                </p>
            </div>
            <!-- Modal Content -->
            <!-- Modal Form -->
            ...
            <div class="flex justify-end gap-4">
                <button id="cancelButton" class="w-full px-4 py-2 bg-white text-Ebony900 border border-Neutral300 rounded-lg">Batal</button>
                <button id="saveButton" class="w-full px-4 py-2 bg-AccentRed900 text-white rounded-lg">Simpan</button>
            </div>
        </div>
    </div>
    <!-- Footer -->
