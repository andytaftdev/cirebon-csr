                ...
                <div class="flex flex-col items-start w-full md:w-1/2">
                    <div class="space-y-1 mb-4">
                        <div class="flex justify-center items-center gap-3">
                            ...
                            @else
                            <span
                                class="px-2 p-1 inline-flex text-xs font-semibold rounded-full bg-Green50 text-Green600">
                                Terverifikasi
                            </span>
                            @endif
                        </div>
        ...
        <div id="deactivateModal"
            ...
            <div class="bg-white rounded-lg p-6 w-full max-w-md">
                ...
                <div class="flex justify-start items-start flex-col">
                    ...
                    <p class="text-Ebony200 mb-4">Mitra akan dinonaktifkan sementara, anda bisa mengaktifkan kembali
                        setelahnya
                    </p>
                </div>
                <!-- Modal Content -->
