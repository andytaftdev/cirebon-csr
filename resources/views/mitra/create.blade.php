    ...
    <div class="flex flex-col w-full md:w-3/4 mx-auto min-h-screen">
        <div class="flex-grow p-7 mx-auto w-full max-w-screen-2xl h-full">
            ...
            <div class="flex items-center space-x-2 mb-4">
                ...
                <a href="#">
                    <span class="text-sm font-medium text-Ebony100 px-2 py-1 rounded-md">Mitra</span>
                </a>
                <a class="flex items-center text-Ebony100">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                        stroke="currentColor" class="w-5 h-5">
                ...
                <span class="text-sm font-medium text-AccentRed900 bg-red-100 px-2 py-1 rounded-md">Buat Mitra</span>
            </div>

            <h2 class="text-2xl font-semibold mb-6 mt-10 text-Ebony900">Buat mitra</h2>

            <!-- Profile Update Form -->
            <div class="bg-white p-8 rounded-lg shadow-md max-w-screen-2xl mx-auto mt-6">
                <form method="POST" action="{{route('identity.register')}}"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                ...
                                <span id="togglePassword"
                                    class="absolute top-5 right-4 flex items-center text-Ebony300 cursor-pointer">
                                    <!-- Eye Icon -->
                    ...
                    <div class="col-span-1">
                        <div class="mb-6">
                            <label for="password_confirmation" class="block text-Ebony900 font-semibold">Konfirmasi Kata
                                Sandi
            ...
            <div class="bg-white shadow-md rounded-lg p-4 px-10 mt-7 mb-20">
                <div class="flex w-full justify-center md:justify-end space-x-4">
                    <a href="/mitra"><button type="button"
                            class="px-4 py-2 text-sm md:text-base bg-white text-Ebony300 border border-Neutral300 hover:bg-gray-100 rounded-lg">Kembali</button></a>
 ...
 document.getElementById('upload').addEventListener('click', function () {
    ...
    document.getElementById('file-input').addEventListener('change', function (event) {
        ...
        if (file) {
            ...
            uploadText.innerHTML = `<span class="font-normal text-Ebony300">Selected file: <span class="text-AccentRed900 font-semibold">${file.name}</span></span>`;
        }
    });
