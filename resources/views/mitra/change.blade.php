...
<div class="flex flex-col w-full min-h-screen">
    <div class="flex-grow p-7 mx-auto w-full max-w-screen-2xl h-full">
        ...
        <h2 class="text-2xl font-bold mb-6 mt-10 text-Ebony900">Ubah Profile Mitra</h2>

        <!-- Profile Update Form -->
        <div class="bg-white p-8 rounded-lg shadow-md max-w-screen-2xl mx-auto mt-6">
            <form method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6" action="{{route('identity.updateMitra' , $identity->id)}}" enctype="multipart/form-data">
                @csrf 
                @method('PUT')
                ...
                <div class="col-span-1">
                    <div class="mb-4">
                        ...
                        <input class="w-full px-4 py-2 border border-Neutral300 rounded-lg" type="email" name="email"
                            value="{{$identity->user->email}}" readonly>
                    </div>
                </div>
                <div class="col-span-1">
                    <div class="mb-4">
...
@endif
        ...
        <div class="bg-white shadow-md rounded-lg p-4 px-10 mt-7 mb-20">
            <div class="flex w-full justify-center md:justify-end space-x-4">
                <a href="/mitra/{{$identity->id}}"><button type="button" class="px-4 py-2 bg-white text-Ebony300 border border-Neutral300 rounded-lg">Kembali</button></a>
