<x-app-layout>
    ...
    <div class="flex flex-col w-full md:w-3/4 mx-auto min-h-screen">
        <div class="flex-grow p-7 mx-auto w-full max-w-screen-2xl h-full">
            ...
            <div class="flex items-center space-x-2 mb-4">
                ...
                <a href="">
                    <span class="text-sm font-medium text-Ebony100 px-2 py-1 rounded-md">Detail</span>
                </a>
                <a class="flex items-center text-Ebony100">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                        stroke="currentColor" class="w-5 h-5">
                ...
                <span class="text-sm font-medium text-AccentRed900 bg-red-100 px-2 py-1 rounded-md">Ubah Profile
                    Mitra</span>
            </div>

            <h2 class="text-2xl font-semibold mb-6 mt-10 text-Ebony900">Ubah Profile Mitra</h2>

            <!-- Profile Update Form -->
            <div class="bg-white p-8 rounded-lg shadow-md max-w-screen-2xl mx-auto mt-6">
                <form method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6"
                    action="{{route('identity.updateMitra' , $identity->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="col-span-1">
                        <div class="mb-4">
                            ...
                            <input class="w-full px-4 py-2 border border-Neutral300 rounded-lg" type="text"
                                name="nama_mitra" value="{{$identity->nama_mitra}}">
                        </div>
                    </div>
                    <div class="col-span-1">
                        <div class="mb-4">
                            <label class="block text-Ebony900 font-semibold mb-2" for="nama_pt">Nama PT<span
                                    class="text-AccentRed900 ml-1">*</span></label>
                            <input class="w-full px-4 py-2 border border-Neutral300 rounded-lg" type="text"
                                name="nama_pt" value="{{$identity->nama_pt}}">
                        </div>
                    </div>
                    <div class="col-span-1">
                        <div class="mb-4">
                            <label class="block text-Ebony900 font-semibold mb-2" for="no_telepon">No Telepon<span
                                    class="text-AccentRed900 ml-1">*</span></label>
                            <input class="w-full px-4 py-2 border border-Neutral300 rounded-lg" type="text"
                                name="nomor_hp" value="{{$identity->nomor_hp}}">
                        </div>
                    </div>
                    <div class="col-span-1">
                        <div class="mb-4">
                            ...
                            <input class="w-full px-4 py-2 border border-Neutral300 rounded-lg" type="email"
                                name="email" value="{{$identity->user->email}}" readonly>
                        </div>
                    </div>
                    <div class="col-span-1">
                        <div class="mb-4">
            ...
            <div class="bg-white shadow-md rounded-lg p-4 px-10 mt-7 mb-20">
                <div class="flex w-full justify-center md:justify-end gap-4">
                    <a href="/mitra/{{$identity->id}}"><button type="button"
                            class="px-4 py-2 text-sm md:text-base bg-white text-Ebony300 border hover:bg-gray-100 border-Neutral300 rounded-lg">Kembali</button></a>

                    <button type="submit"
                        class="px-4 py-2 text-sm md:text-base bg-AccentRed900 hover:bg-red-700 text-white rounded-lg flex justify-center items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
    ...
    document.getElementById('file-input').addEventListener('change', function (event) {
        ...
        if (file) {
            ...
            // Change the text to "Selected file: [file name]" with semibold and AccentRed900 color
            uploadText.innerHTML = `<span class="font-normal text-Ebony300">Selected file:<span class="font-semibold text-AccentRed900"> ${file.name}</span></span>`;
        }
    });
