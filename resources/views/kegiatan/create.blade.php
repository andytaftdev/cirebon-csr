...
<div class="flex flex-col w-full min-h-screen">
    ...
    <div class="flex-grow p-7 mx-auto w-full max-w-screen-2xl h-full">
        ...
        <h2 class="text-2xl font-bold mb-6 mt-10 text-Ebony900">Buat Kegiatan</h2>

        <!-- Form Section -->
        <div class="bg-white p-8 rounded-lg shadow-md max-w-screen-2xl mx-auto mt-6">
            <form method="POST" action="{{route('kegiatan.store')}}" class="flex flex-col gap-6" enctype="multipart/form-data" id="myForm">
                @csrf
                <!-- Thumbnail Section -->
                ...
                <div class="mb-4">
                    ...
                    <div id="description-editor" name="deskripsi" class="w-full px-4 py-2 border border-Neutral300 rounded-lg"></div>
