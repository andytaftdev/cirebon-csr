    ...
    <div class="flex flex-col w-full md:w-3/4 mx-auto min-h-screen">
        <div class="flex-grow p-7 mx-auto w-full max-w-screen-2xl h-full">
            ...
            <div class="flex items-center space-x-2 mb-4">
                ...
                <span class="text-sm font-medium text-AccentRed900 bg-red-100 px-2 py-1 rounded-md">Buat Kegiatan</span>
            </div>

            <h2 class="text-2xl font-semibold mb-6 mt-10 text-Ebony900">Buat Kegiatan</h2>

            <!-- Form Section -->
            <div class="bg-white p-8 rounded-lg shadow-md max-w-screen-2xl mx-auto mt-6">
                <form method="POST" action="{{route('kegiatan.store')}}" class="flex flex-col gap-6"
                    ...
                    <div>
                        <label class="block text-Ebony900 font-semibold mb-2" for="tags">Tags<span
                                class="text-AccentRed900 ml-1">*</span></label>
                        <input id="tags" name="tags" placeholder="Add tags"
                    ...
                    <div>
                        ...
                        <div id="description-editor" name="deskripsi"
                            class="w-full px-4 py-2 border border-Neutral300"></div>
                        <input type="hidden" id="descriptionInput" value="" name="deskripsi">
                    </div>

                    <input type="humber" hidden id="statusInput" value="" name="status">
                    @if ($errors->any())
            ...
            <!-- Buttons Section -->
            <div class="bg-white justify-center items-center md:justify-end shadow-md rounded-lg p-4 px-10 mt-7 mb-20">
