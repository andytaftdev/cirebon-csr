...
<div class="flex flex-col w-full min-h-screen">
    <div class="flex-grow p-7 mx-auto w-full max-w-screen-2xl h-full">
        ...
        <h2 class="text-2xl font-bold mb-6 mt-10 text-Ebony900">Ubah Profile</h2>

        <!-- Profile Update Form -->
        <div class="bg-white p-8 rounded-lg shadow-md max-w-screen-2xl mx-auto mt-6">
            <form method="POST" action="{{route('identity.update' , $identity->id)}}" class="grid grid-cols-1 md:grid-cols-2 gap-6" enctype="multipart/form-data">
                @csrf
                {{method_field('PUT')}}
                <!-- Image Section -->
                ...
                <div class="col-span-1">
                    <div class="mb-4">
                        ...
                        <input class="w-full px-4 py-2 border border-Neutral300 rounded-lg" type="text" name="nama_mitra"
                            placeholder="Nama Mitra" value="{{$identity->nama_mitra}}">
                    </div>
                </div>
                <div class="col-span-1">
                    <div class="mb-4">
                        ...
                        <input class="w-full px-4 py-2 border border-Neutral300 rounded-lg" type="text" name="nama_pt"
                            placeholder="Nama PT" value="{{$identity->nama_pt}}">
                    </div>
                </div>
                <div class="col-span-1">
                    <div class="mb-4">
                        ...
                        <input class="w-full px-4 py-2 border border-Neutral300 rounded-lg" type="text" name="nomor_hp"
                            placeholder="No Telepon" value="{{$identity->nomor_hp}}">
                    </div>
                </div>
                <div class="col-span-1">
                    <div class="mb-4">
...
@endif
        ...
        <div class="bg-white shadow-md rounded-lg p-4 px-10 mt-7 mb-20">
            <div class="flex w-full justify-center md:justify-end space-x-4">
               <a href="/identity"><button class="px-4 py-2 bg-white text-Ebony300 border border-Neutral300 rounded-lg">Kembali</button></a> 
...
<div class="flex flex-col w-full min-h-screen">
    <div class="flex-grow p-7 mx-auto w-full max-w-screen-2xl h-full">
        ...
        <!-- Profile Update Form -->
        <div class="bg-white p-8 rounded-lg shadow-md max-w-screen-2xl mx-auto mt-6">
            <form method="POST" action="{{route('identity.update' , $identity->id)}}" class="flex flex-col gap-6"  enctype="multipart/form-data">
                @csrf
                {{method_field('PUT')}}
                    ...
                    <div class="w-full md:h-80 md:w-96">
                        <div class="w-full h-60 max-w-60 md:h-80 md:max-w-80 relative">
                            <img class="absolute inset-0 w-full h-full object-cover rounded-xl"
                                id="preview"src="{{ $identity->mitra_logo ?? '' }}" alt="">
                        </div>
                    </div>
                ...
                <div class="flex flex-col gap-4">
                    <div class="mb-4">
                        <label class="block text-Ebony900 font-semibold mb-2" for="name">Nama<span
                                class="text-AccentRed900 ml-1">*</span></label>
                        <input class="w-full px-4 py-2 border border-Neutral300 rounded-lg" type="text" name="nama_mitra"
                            placeholder="Nama" value="{{$identity->nama_mitra}}">
                    </div>
                    <div class="mb-4">
                        <label class="block text-Ebony900 font-semibold mb-2" for="email">Email<span
                                class="text-AccentRed900 ml-1">*</span></label>
