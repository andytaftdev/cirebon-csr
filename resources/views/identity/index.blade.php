    ...
    <div class="flex-grow p-7 mx-auto w-full max-w-screen-2xl h-full">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mt-10 space-y-4 md:space-y-0">
            ...
            <form action="{{ route('logout') }}" method="post">
                @csrf
            <button type="submit" class="border-AccentRed900 border bg-white text-AccentRed900 text-sm flex justify-center items-center px-5 py-3 rounded-lg gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.2" stroke="currentColor" class="w-5 h-5 text-AccentRed900">
        ...
        <div class="bg-white flex flex-col md:flex-row justify-between mt-10 p-6 md:p-12 rounded-xl shadow-md mx-auto max-w-full">
            <div class="flex justify-center flex-col items-center w-full md:w-1/3 mb-6 md:mb-0 relative">
                <div class="w-full h-80 max-w-96 relative">
                    <img class="absolute inset-0 w-full h-full object-cover rounded-xl" src="{{ asset('storage/img/profile/'. $identity->mitra_logo) }}" alt="">
                </div>
            </div>
            <div class="flex flex-col items-start w-full md:w-1/2">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center space-x-0">
                        <div class="w-10 h-10 bg-AccentRed100 rounded-full flex items-center justify-center mr-4 cursor-pointer">
                            <div class="bg-Red100 w-8 h-8 rounded-full flex justify-center items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="size-5 text-AccentRed900">
...
<div class="flex flex-col w-full min-h-screen">
    ...
    <div class="flex-grow p-7 mx-auto w-full max-w-screen-2xl h-full">
        ...
        <div class="bg-white flex flex-col md:flex-row justify-center mt-10 p-6 md:p-12 rounded-xl shadow-md mx-auto max-w-full md:max-w-none">
            <div class="flex justify-center flex-col items-center w-full md:w-1/3zz mb-6 md:mb-0 relative">
            ...
            <div class="flex justify-center flex-col items-start w-full md:w-1/2 gap-2">
                <h2 class="font-semibold text-2xl text-Ebony900 text-center md:text-left">{{$identity->nama_mitra}}</h2>
