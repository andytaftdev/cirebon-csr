...
<div class="container my-6 mx-auto p-5 flex items-center space-x-2">
...
<div class="container mx-auto mt-6 flex flex-row justify-between">
    <h1 class="text-2xl font-semibold text-gray-800">Sektor</h1>
    <a href="{{route('sektor.create')}}" class="px-5 py-3 bg-red-800 text-white rounded-lg hover:bg-red-900">+ Buat Kegiatan Baru</a>
</div>

<div class="container mx-auto rounded-lg mt-4">

    <!-- Search Bar -->
    <div class="mb-6">
        <input type="text" placeholder="Cari" class="w-full px-4 py-2 border border-gray-300 rounded-lg">
    </div>

    <!-- Table -->
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg mb-16">
        <table class="w-full text-left rtl:text-right">
            <thead class="text-sm uppercase bg-white text-Gray900 border border-Neutral200">
                <tr>
                ...
                <tr class="bg-white border border-Neutral200">
                    ...
                    <td class="px-6 py-4 space-x-3 justify-center flex whitespace-nowrap">
                                <div class="flex items-center gap-4">
                                    <a href="{{ route('sektor.detail', $item->id) }}" class="text-Ebony300 hover:text-Ebony900">
                                        <!-- Eye Icon -->
                                    ...
                                    <a href="{{ route('sektor.edit', $item->id) }}" class="text-Ebony300 hover:text-Ebony900">
                                        <!-- Pencil Icon -->
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
