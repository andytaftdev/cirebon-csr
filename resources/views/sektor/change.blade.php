        ...
        <form id="dataFormSubmit" enctype="multipart/form-data" action="{{route('sektor.update', $sektor->id)}}"
            ...
            <div class="bg-white border border-Neutral200 rounded-lg p-6 mb-6">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" value="{{$sektor->nama_sektor}}" name="nama_sektor" class="w-full px-3 py-2 border border-gray-300 rounded-lg"
                        ...
                        <div class="program-item flex flex-col md:flex-row mb-4 gap-4">
                            <div class="w-full">
                                ...
                                <input type="text" name="nama_program[]"
                                    ...
                                    placeholder="Masukkan nama program" value="{{$item->nama_program}}"/>
                            </div>
                            <div class="w-full">
                                ...
                                <textarea name="deskripsi[]" class="w-full px-3 py-2 border border-gray-300 rounded-lg"
                                    rows="2" placeholder="Masukkan deskripsi program">{{$item->deskripsi}}</textarea>
                            </div>
