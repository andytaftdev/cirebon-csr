    ...
    <div class="mt-12 mb-4">
        <div class="flex justify-between items-center mb-2">
            <div class="flex space-x-4 w-3/4">
                ...
                <button class="bg-AccentRed900 text-white px-4 py-2 rounded-lg">Terapkan filter</button>
                <!-- Margin kanan ditambahkan di sini -->
            </div>
            <div class="flex space-x-4">
                <button class="bg-white text-Green600 border border-Neutral300 px-4 py-2 rounded-lg flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
        ...
        <h1 class="text-2xl text-left text-Ebony900 my-6 font-semibold">Data Statistik</h1>
    </div>
            ...
            <div class="flex items-center">
                <div class="w-10 h-10 bg-white rounded-full flex items-center justify-center mr-4">
                    <div class="bg-Blue50 w-8 h-8 rounded-full flex justify-center items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.2" stroke="currentColor" class="size-5 text-Blue700">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M6 6.878V6a2.25 2.25 0 0 1 2.25-2.25h7.5A2.25 2.25 0 0 1 18 6v.878m-12 0c.235-.083.487-.128.75-.128h10.5c.263 0 .515.045.75.128m-12 0A2.25 2.25 0 0 0 4.5 9v.878m13.5-3A2.25 2.25 0 0 1 19.5 9v.878m0 0a2.246 2.246 0 0 0-.75-.128H5.25c-.263 0-.515.045-.75.128m15 0A2.25 2.25 0 0 1 21 12v6a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 18v-6c0-.98.626-1.813 1.5-2.122" />
                        </svg>            
                    </div>
                </div>
                <div class="text-lg">Mitra Bergabung</div>
            </div>
...
<div class="container mx-auto w-full mb-20">
    ...
    <div class="p-6 bg-white rounded-lg shadow-md">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 px-12">
            ...
            <div>
                <h2 class="text-xl font-semibold mb-4 text-Ebony900">Persentase total realisasi berdasarkan PT</h2>
                <div id="chart-bar-pt"></div>
            </div>
            <div>
                <h2 class="text-xl font-semibold mb-4 text-Ebony900">Persentase total realisasi berdasarkan Kecamatan
                </h2>
                <div id="chart-bar-kecamatan"></div>
            </div>
        </div>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var optionsPie = {
            ...
            series: [44, 100, 52, 37, 22, 69, 72],
            labels: ['Sosial', 'Lingkungan', 'Kesehatan', 'Pendidikan', 'Infrastruktur dan lingkungan',
                'Sarana dan prasarana keagamaan', 'Lainnya'
            ],
            colors: ['#28A0F6', '#4E5BA6', '#7A5AF8', '#EE46BC', '#B42121', '#F95016', '#FAC515'],
            dataLabels: {
                enabled: false
        ...
        const chartBarPT = new ApexCharts(document.querySelector("#chart-bar-pt"), {
            chart: {
                type: 'bar',
            },
            series: [{
            ...
            xaxis: {
                categories: ['PT A', 'PT B', 'PT C', 'PT D', 'PT E']
            },
            yaxis: {
                labels: {
                    style: {
        ...
        const chartBarKecamatan = new ApexCharts(document.querySelector("#chart-bar-kecamatan"), {
            chart: {
                type: 'bar',
            },
            series: [{
            ...
            xaxis: {
                categories: ['Kecamatan A', 'Kecamatan B', 'Kecamatan C', 'Kecamatan D', 'Kecamatan E']
            },
            yaxis: {
                labels: {
                    style: {
