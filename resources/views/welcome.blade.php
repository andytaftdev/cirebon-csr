...
<div class="w-full min-h-screen flex flex-col relative">
    <section class="w-full h-screen flex justify-center items-center relative">
        <div class="-z-50 h-screen w-2/5 bg-AccentRed950">
        </div>
        <div class="-z-50 w-3/5 bg-white">
        </div>
        <div class="absolute inset-0 flex flex-col lg:items-start items-center lg:text-left text-center justify-center px-16 lg:px-32">
            <h1 class="text-white text-4xl lg:text-6xl font-bold mb-4 max-w-lg tracking-wide">Selamat Datang Di Portal CSR
                Kab. Cirebon</h1>
            <p class="text-white text-base lg:text-xl max-w-lg font-medium mb-4">Ketahui Dan Kenali Customer Social
                Responsibility Terhadap Kabupaten Cirebon Dari Para Mitra.</p>
            <div class="bg-white w-96 h-px"></div>
        </div>
    
        <!-- Image berada di tengah-tengah div merah dan abu-abu -->
        <img src="{{ asset('images/background.png') }}" alt="Image Dashboard"
        class="absolute px-10 w-[1424px] h-[712px] object-cover -z-10" style="transform: translateX(-50%); left: 50%;">
    
        <!-- Blue Overlay Section -->
        <div id="carousel">
            <div class="absolute bottom-0 right-0 lg:right-20 bg-Gray900 bg-opacity-85 px-6 py-5 lg:px-12 lg:py-11 max-w-md lg:max-w-xl">
                {{-- <h2 class="text-white md:text-2xl font-semibold mb-4">Pemkab Cirebon Terima Bantuan PJU Tematik Dari Bank BJB</h2>
                <span class="text-white text-[10px] px-3 py-2 bg-AccentRed900 uppercase tracking-widest">Jum'at, 24 Jul 2024</span>
                <p class="text-white text-sm md:text-base leading-relaxed mt-4">Penyerahan bantuan ini dihadiri langsung oleh Penjabat (Pj) Bupati Cirebon, Drs H Wahyu Mijaya SH MSi di Pendopo Bupati Cirebon, Jumat (12/7/2024). “Kami berterima kasih kepada Bank BJB yang telah memberikan PJU untuk dipasang di beberapa titik di wilayah Sumber, Kabupaten Cirebon,” ujar Wahyu. Ia menjelaskan, bahwa pemasangan PJU di kawasan Sumber, yang dekat dengan kantor pe...</p> --}}
    
                <div class="relative overflow-hidden">
                    <div class="carousel-item block duration-700 ease-in-out transform translate-x-0 opacity-100">
                        <h2 class="text-white text-lg lg:text-2xl font-semibold mb-4">Pemkab Cirebon Terima Bantuan PJU Tematik Dari
                            Bank BJB</h2>
                        <span class="text-white text-[8px] lg:text-[10px] px-3 py-2 bg-AccentRed900 uppercase tracking-widest">Jum'at, 24
                            Jul 2024</span>
                        <p class="text-white text-xs lg:text-base leading-relaxed mt-4">Penyerahan bantuan ini dihadiri
                            langsung oleh Penjabat (Pj) Bupati Cirebon, Drs H Wahyu Mijaya SH MSi di Pendopo Bupati Cirebon,
                            Jumat (12/7/2024). “Kami berterima kasih kepada Bank BJB yang telah memberikan PJU untuk
                            dipasang di beberapa titik di wilayah Sumber, Kabupaten Cirebon,” ujar Wahyu. Ia menjelaskan,
                            bahwa pemasangan PJU di kawasan Sumber, yang dekat dengan kantor pe...</p>
                    </div>
    
                    <div class="carousel-item hidden duration-700 ease-in-out transform translate-x-0 opacity-0">
                        <h2 class="text-white text-lg lg:text-2xl font-semibold mb-4">
                            Tes123Tes123Tes123Tes123Tes123Tes123Tes123Tes123Tes123</h2>
                        <span class="text-white text-[8px] lg:text-[10px px-3 py-2 bg-AccentRed900 uppercase tracking-widest">Jum'at, 24
                            Jul 2024</span>
                        <p class="text-white text-xs lg:text-base leading-relaxed mt-4">Penyerahan bantuan ini dihadiri
                            langsung oleh Penjabat (Pj) Bupati Cirebon, Drs H Wahyu Mijaya SH MSi di Pendopo Bupati Cirebon,
                    ...
                    <div class="carousel-item hidden duration-700 ease-in-out transform translate-x-0 opacity-0">
                        <h2 class="text-white text-lg lg:text-2xl font-semibold mb-4">Lorem ipsum dolor, sit amet consectetur
                            adipisicing elit.</h2>
                        <span class="text-white text-[8px] lg:text-[10px px-3 py-2 bg-AccentRed900 uppercase tracking-widest">Jum'at, 24
                            Jul 2024</span>
                        <p class="text-white text-xs lg:text-base leading-relaxed mt-4">Penyerahan bantuan ini dihadiri
                    ...
                    <div class="carousel-item hidden duration-700 ease-in-out transform translate-x-0 opacity-0">
                        <h2 class="text-white text-lg lg:text-2xl font-semibold mb-4">haihaihaihahihaihaihahihaihaihahi</h2>
                        <span class="text-white text-[8px] lg:text-[10px px-3 py-2 bg-AccentRed900 uppercase tracking-widest">Jum'at, 24
                            Jul 2024</span>
                        <p class="text-white text-xs lg:text-base leading-relaxed mt-4">Penyerahan bantuan ini dihadiri
                            langsung oleh Penjabat (Pj) Bupati Cirebon, Drs H Wahyu Mijaya SH MSi di Pendopo Bupati Cirebon,
                    ...
                    <div class="carousel-item hidden duration-700 ease-in-out transform translate-x-0 opacity-0">
                        <h2 class="text-white text-lg lg:text-2xl font-semibold mb-4">Ini Kelima Dan Terakhirrr</h2>
                        <span class="text-white text-[8px] lg:text-[10px px-3 py-2 bg-AccentRed900 uppercase tracking-widest">Jum'at, 24
                            Jul 2024</span>
                        <p class="text-white text-xs lg:text-base leading-relaxed mt-4">Penyerahan bantuan ini dihadiri
                            langsung oleh Penjabat (Pj) Bupati Cirebon, Drs H Wahyu Mijaya SH MSi di Pendopo Bupati Cirebon,
    ...
    <!-- Mitra CSR Section -->
    <section class="relative py-12 px-8 md:px-16 lg:px-32 bg-white flex flex-col justify-center">
        <img src="{{ asset('images/squares.png') }}" alt="squares-1" class="absolute top-0 right-0 h-36 w-36">
        <h2 class="text-3xl md:text-4xl font-bold text-Color121C22 mb-8 max-w-md z-20">Mitra CSR Kabupaten Cirebon</h2>
        <div class="grid grid-cols-2 lg:grid-cols-5 z-30">
            ...
            <div class=" flex items-center justify-center border-gray-200 p-9 border-b lg:border-b-0 lg:border-r">
            ...
            <div class=" flex items-center justify-center border-gray-200 p-9 lg:border-r border-b lg:border-b-0">
    ...
    <section class="py-12 px-8 md:px-16 lg:px-32 bg-white flex flex-col justify-center">
    ...
    <section class="relative py-12 px-8 md:px-16 lg:px-32 bg-white flex xl:flex-row flex-col-reverse">
        <img src="{{ asset('images/squares-2.png') }}" alt="squares-2" class="absolute top-0 left-0 h-36 w-36">

        <div class="xl:w-[54%] w-full relative flex flex-col">
            <img src="{{ asset('images/kegiatan-csr-2.png') }}" alt="img-kegiatan-csr-2"
                class="xl:block hidden absolute top-24 xl:left-10 w-56 h-36">
            <img src="{{ asset('images/kegiatan-csr-1.png') }}" alt="img-kegiatan-csr-1"
                class="shadow-lg xl:absolute xl:top-14 xl:right-10 xl:m-0 m-5 h-52 w-80">
            <img src="{{ asset('images/kegiatan-csr-3.png') }}" alt="img-kegiatan-csr-3"
                class="shadow-lg xl:block hidden absolute bottom-32 -left-16 h-52 w-80">
        </div>

        <div class="flex flex-col w-full xl:w-[46%] p-5">
            <div class="bg-AccentRed400 h-1 w-12 mb-4 z-30"></div>
            <h2 class="text-3xl md:text-4xl font-bold text-[#121C22] mb-8 z-20 max-w-64">Apa Itu Kegiatan CSR?</h2>
    ...
    <!-- Sektor CSR Section -->
    <section class="relative py-24 px-8 md:px-16 lg:px-32 bg-Gray900 text-white">
        <img src="{{ asset('images/squares-3.png') }}" alt="squares-3" class="absolute top-0 right-0 w-52">
    ...
    @endphp
                ...
                <div class="relative lg:w-1/2 w-full flex flex-col items-center justify-center mt-8">
                    <div id="content-img" style="" alt="sektor-csr-img" class=" lg:absolute h-72 lg:top-0 lg:left-7 lg:block hidden w-96 bg-center bg-cover"></div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <button class="w-full py-3 px-4 bg-AccentRed900 hover:bg-red-900 rounded-lg text-white mt-4">
    ...
    <section class="relative py-16 px-8 lg:px-24 bg-white">

        <div src="{{ asset('images/squares-2.png') }}" alt="squares-2" class="absolute top-0 left-0 h-36 w-36"></div>
    ...
    <section class="relative py-16 px-8 lg:px-24 bg-white">
        <img src="{{ asset('images/squares-4.png') }}" alt="squares-4" class="absolute bottom-0 left-0 h-36">
        <div class="container mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-7 p-6">
                ...
                <a href="{{route('kegiatan.detailKegiatan', $item->id)}}"> <div class="bg-white border border-Neutral300 overflow-hidden relative">
                    <img class="w-full h-72 object-cover" src="{{ asset('storage/img/kegiatan/'. $item->gambar_kegiatan) }}" alt="Image 1">
                    <span class="text-xs text-white bg-AccentRed900 px-4 py-2 rounded absolute top-5 left-5 z-20">{{$item->month}} {{$item->day}} {{$item->year}}</span>
                    <div class="p-6">
            ...
            <a href="{{route('kegiatan.kegiatanPublik')}}"><button class="bg-white hover:bg-neutral-100 border border-Neutral300 font-semibold rounded-lg text-Ebony200 px-4 py-2 flex justify-center items-center my-7 mx-auto z-50">Lihat semua kegiatan</button></a>
    </section>
    
    <!-- Section: Laporan Program Terbaru -->
    <section class="relative py-16 px-8 lg:px-24 bg-white">
        <img src="{{ asset('images/squares-4.png') }}" alt="squares-4" class="absolute bottom-0 right-0 h-36">
        <div class="container mx-auto">
            <div class="flex flex-col justify-center items-center">
                <div class="w-[44px] h-[4px] bg-Orange600"></div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-7 p-6">
                <!-- Card 1 -->
                 ...
                 @endphp
                <a href="{{route('laporan.detailLaporan', $item->id)}}"><div class="bg-white border border-Neutral300 overflow-hidden relative">
                    <img class="w-full h-72 object-cover" src="{{ asset('storage/img/laporan/'. $gambarLaporan[0]) }}" alt="Image 1">
                    <!-- Date overlay -->
                    <span class="text-xs text-white bg-AccentRed900 px-4 py-2 rounded absolute top-5 left-5 z-20">27 MAR,
                        2023</span>
                    <div class="p-6">
                        <h2 class="mt-2 text-xl font-bold text-Ebony900">Judul Kegiatan Terbaru.</h2>
                        <p class="mt-2 text-Ebony100">Praesent viverra sapien congue aliquet viverra maecenas sed bibendum.
            ...
            <a href="{{route('laporan.laporanPublik')}}"><button class="bg-white hover:bg-neutral-100 border border-Neutral300 font-semibold rounded-lg text-Ebony200 px-4 py-2 flex justify-center items-center my-7 mx-auto">Lihat semua laporan program</button></a>
    </section>
        ...
        <div class="container mx-auto flex flex-col">
            ...
            <div class="w-full flex flex-col lg:flex-row lg:space-x-14">
                ...
                <div class="relative w-full lg:w-1/2 flex flex-col mt-8">
                    <p id="content-faq" class="text-gray-300 mb-4 text-base">CSR atau Corporate Social Responsibility adalah komitmen perusahaan untuk berkontribusi dalam pembangunan berkelanjutan dengan cara memberikan dampak positif bagi masyarakat dan lingkungan sekitar. Di Kabupaten Cirebon, CSR dapat diwujudkan melalui berbagai program seperti pendidikan, kesehatan, lingkungan, dan pemberdayaan masyarakat.</p>
                </div>
            </div>
    ...
    <div class="w-screen bg-white shadow-lg rounded-lg py-[50px] px-14 md:px-[100px] mx-auto flex flex-col md:flex-row">
        <div class="flex flex-col w-full md:w-1/2 space-y-4">
            <div class="w-[40px] h-[4px] bg-Orange600"></div>
            <h2 class="text-3xl md:text-4xl font-bold text-Ebony900 lg:mb-4">Hubungi Kami</h2>
            <p class="text-Ebony100 text-lg mb-6">
            ...
            <div class="space-y-6">
                <div class="flex items-center">
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="font-semibold text-AccentRed900">
        ...
        <div class="w-full flex justify-end md:w-1/2 overflow-hidden mt-5 md:mt-0">
