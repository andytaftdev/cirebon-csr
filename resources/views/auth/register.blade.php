...
<div class="min-h-screen flex flex-col justify-between bg-Neutral50">
    ...
    <div class="flex-grow flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-7xl bg-white rounded-lg shadow-md flex flex-col md:flex-row overflow-hidden">
            <div class="w-full md:w-1/2 flex flex-col justify-center p-8 md:px-20 bg-Neutral50">
                <a href="{{ url('/') }}" class="text-AccentRed900 flex items-center font-medium mb-6 gap-2">
                ...
                <h2 class="text-3xl font-semibold text-Ebony900">Registrasi Mitra</h2>
                <p class="text-Ebony300 mt-2">Silakan masukan email dan kata sandi untuk masuk ke halaman dashboard Anda</p>
                <a href="{{route('login')}}"
                    class="font-semibold text-Ebony900 mt-5 inline-block border border-Neutral300 w-fit rounded-lg px-4 py-2">
                    Sudah punya akun? <span class="text-AccentRed900">Klik di sini</span>
                </a>
            </div>
            <div class="w-full md:w-1/2 flex flex-col justify-center h-full md:border-t-0 md:border-l py-12 px-8">
                <form action="{{ route('register')}}" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="name" class="block text-Ebony900 font-semibold">Nama Perusahaan <span
                                class="text-AccentRed900">*</span></label>
                        <input type="text" name="name" id="name"
                            class="mt-2 w-full p-3 border border-Neutral300 rounded-lg"
                            placeholder="Masukan nama perusahaan Anda" required>
                    </div>
                    <div class="mb-4">
                    ...
                    <button type="submit" class="w-full text-white p-3 rounded-lg"
                        style="background-color: #98100A;">Daftar</button>
                </form>
            </div>
        </div>
    </div>

    <footer class="bg-gray-900 p-6 overflow-hidden">
    <div class="w-full md:w-3/4 mx-auto flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
        <div class="text-center md:text-left space-y-0.5">
            <p class=" text-white text-sm md:text-base">&copy; 2024 Corporate Social Responsibility Kabupaten Cirebon</p>
            <p class="text-Neutral300 text-sm md:text-sm">Pemkab Kabupaten Cirebon, Badan Pendapatan Daerah (Bapenda) Kabupaten Cirebon.</p>
        </div>
        <div class="flex justify-center md:justify-end items-center">
            <a href="/" class="inline-block text-sm text-white py-2 px-4 rounded-lg border border-gray-300 hover:bg-gray-800 text-nowrap">
