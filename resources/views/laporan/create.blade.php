...
<div class="container mx-auto mt-6 mb-16">
    <form  method="POST" action="{{route('laporan.store')}}" class="flex flex-col gap-6" enctype="multipart/form-data" class="space-y-5" id="myForm">
        @csrf
        <div class="bg-white p-6 border border-Neutral rounded-lg">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="judul" name="judul" class="w-full border border-gray-200 rounded-lg px-3 py-2 focus:outline-none" placeholder="Masukan nama laporan CSR">
    ...
    <option value="2023">2023</option>
                ...
                <div class="w-1/2 grid grid-cols-1">
                    <div>
                        ...
                        <input type="number" id="realisasi" name="realisasi" class="w-full text-Neutral500 border border-gray-200 rounded-lg px-3 py-2 focus:outline-none" placeholder="Rp 0">
                    </div>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea id="deskripsi" name="deskripsi" class="w-full text-sm text-Neutral500 border border-Neutral200 rounded-lg px-3 py-2 focus:outline-none" placeholder="Deskripsi"></textarea>
            </div>
...
<input type="text" id="statusInput" name="status" class="hidden" >
        ...
        <div class="flex justify-end rounded-lg border border-Neutral200 bg-white py-4 px-6 space-x-4">
            <button id="submitButtons" type="button" class="px-4 py-2 bg-white text-Neutral700 border border-Neutral300 rounded-lg text-center flex justify-center items-center hover:bg-Neutral200">Simpan Sebagai Draft</button>
            <button id="submitButton" type="button" class="px-4 py-2 bg-red-800 text-white rounded-lg text-center flex justify-center items-center">Submit</button>
        </div>
    </form>
</div>
