<x-app-layout>
    <main class="flex-grow">
        ...
        <div class="container w-full md:w-3/4 mx-auto py-5 px-6 md:px-0 flex items-center space-x-2">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="size-5 text-Ebony100">
        ...
        <div class="container md:w-3/4 mx-auto py-8 px-6 md:px-0">
            <div class="flex items-center justify-between">
                ...
                <a href="{{route('laporan.create')}}"><button
                        class="bg-AccentRed900 hover:bg-red-700 text-white text-sm md:text-base px-4 py-2 rounded-lg">
                        + Buat Laporan Baru
                    </button>
                </a>
            </div>

            <form method="GET" action="{{ route('laporan.search') }}" class="mt-6">
                @csrf
                <div class="mb-8">
                    <input type="text" name="search" placeholder="Cari"
                        class="w-full px-4 py-2 rounded-lg border border-gray-300" value="{{ request('search') }}">
                </div>
            </form>
                ...
                <table class="w-full text-left rtl:text-right">
                    ...
                    <tbody class="text-Neutral700 text-sm whitespace-nowrap">
                        ...
                        <tr class="bg-white border-b border-Neutal200">
                            ...
                            <td class="px-6 py-4">{{$item->releaseDay}} {{$item->releaseMonth}} {{$item->releaseYear}}
                            </td>
                            <td class="px-6 py-4">
                                @if($item->status === 'terima')
                                <span
                                    class="bg-Success50 text-Success700 py-1 px-3 rounded-full text-xs">Diterima</span>
        ...
        <div class="container w-full px-6 md:px-0 md:w-3/4 my-4 mx-auto py-5 flex items-center space-x-2">
            <div class="flex items-center space-x-2 mb-4">
                ...
                <span class="text-sm font-medium text-AccentRed900 bg-red-100 px-2 py-1 rounded-md">Laporan</span>
            </div>
        </div>
                ...
                <div
                    ...
                    <div class="flex flex-col md:flex-row md:space-x-4 w-full space-y-4 md:space-y-0">
                        ...
                        <form method="GET" action="{{ route('laporan.filter') }}"
                            class="flex flex-wrap lg:flex-nowrap lg:flex-row w-full lg:gap-3">
                            @csrf
