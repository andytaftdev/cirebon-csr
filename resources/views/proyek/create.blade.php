        ...
        <form enctype="multipart/form-data" action="{{route('proyek.store')}}" method="post">
            ...
            <div class="p-6 bg-white rounded-lg shadow-md mb-6">
                ...
                <div class="mb-4">
                    ...
                    <input name="nama_proyek" id="nama-proyek" type="text" placeholder="Masukan nama proyek CSR"
                ...
                <div class="mb-4">
                    ...
                    <textarea name="deskripsi" id="deskripsi" placeholder="Masukan Deskripsi Proyek"
                        class="w-full px-4 py-2 border border-Neutral200 rounded-lg"></textarea>
                </div>
