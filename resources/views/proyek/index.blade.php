<x-app-layout>
    ...
    <div class="container w-full md:w-3/4 px-6 md:px-0 mx-auto mt-6 flex flex-row justify-between items-center">
        <h1 class="text-2xl font-semibold text-Ebony900">Proyek</h1>
        <a href="{{route('proyek.create')}}"><button
                class="bg-AccentRed900 hover:bg-red-700 text-white px-4 p-2 rounded-lg">+ Buat
                Proyek Baru</button></a>
    </div>
    ...
    <div class="container w-full md:w-3/4 px-6 md:px-0 mx-auto rounded-lg mt-6">
        ...
        <div class="flex items-center space-x-4 mb-4">
            <a href="{{ route('proyek.filter', ['status' => 'semua']) }}">
                <button
                    class="px-4 py-2 font-medium rounded-full {{ request()->route('status') === 'semua' || is_null(request()->route('status')) ? 'active-button' : 'text-Ebony200' }}">
                    Semua
                </button>
            </a>
        ...
        <div class="flex flex-row justify-center items-center w-full space-x-2 my-6 gap-3">
            ...
            <div class="w-full hidden lg:flex flex-row items-center lg:justify-end lg:w-fit gap-3">
                ...
                <button class="px-4 py-2 flex justify-center items-center text-nowrap bg-white text-YellowGreen600 hover:bg-Green50 rounded-lg border border-Neutral300">
                ...
                <a href="{{route('proyek.pdf')}}">
                <button class="px-4 py-2 flex justify-center items-center text-nowrap bg-white text-AccentRed900 hover:bg-AccentRed100 rounded-lg border border-Neutral300">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                        stroke="currentColor" class="size-5">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12 12 16.5m0 0L7.5 12m4.5 4.5V3" />
        ...
        <div class="w-full lg:hidden flex flex-row items-center justify-center gap-3 mb-5">
            ...
            <button class="w-full py-2 flex justify-center items-center gap-2 text-nowrap bg-white text-YellowGreen600 hover:bg-Green50 rounded-lg border border-Neutral300">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                    stroke="currentColor" class="size-5">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12 12 16.5m0 0L7.5 12m4.5 4.5V3" />
            ...
            <button class="w-full py-2 flex justify-center items-center gap-2 text-nowrap bg-white text-AccentRed900 hover:bg-AccentRed100 rounded-lg border border-Neutral300">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                    stroke="currentColor" class="size-5">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12 12 16.5m0 0L7.5 12m4.5 4.5V3" />
