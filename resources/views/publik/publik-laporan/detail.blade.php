    ...
    <div class="w-full min-h-screen flex flex-col relative">
        <div class="w-full h-auto flex justify-center items-center relative">
            ...
            <div
                ...
                <p class="text-white text-sm md:text-base"><span class="text-OrangeS">Beranda / Laporan</span> / Rincian
                </p>
                <h1 class="text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mt-3">{{$laporan->judul}}
                </h1>
                <p class="text-gray-300 text-sm md:text-base my-4">PT {{$laporan->user}} · {{$laporan->bulan}}
                    {{$laporan->tanggal}} {{$laporan->tahun}}</p>
        ...
        <div class="w-full px-7 md:px-0 md:w-3/4 mt-12 mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-5 mb-8">
                ...
                <div class="overflow-hidden relative">
                    <img class="w-full h-44 object-cover" src="{{ asset('storage/img/laporan/'. $item) }}"
                        alt="Image 1">
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="p-4 bg-AccentRed100 space-y-1 rounded-md border-l-4 border-AccentRed900">
                    ...
                    <p class="text-base md:text-lg font-bold text-Ebony900">
                        Rp.{{number_format($laporan->realisasi, 0, ',', ',')}}</p>
                </div>
                {{-- Card 2 --}}
                <div class="p-4 bg-AccentRed100 space-y-1 rounded-md border-l-4 border-AccentRed900">
            ...
            <div class="w-[40px] h-[4px] bg-Orange600 mt-12"></div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-7 p-2 md:p-6">
                ...
                <a href="{{route('laporan.detailLaporan', $item->id)}}">
                    <div class="bg-white border border-Neutral300 overflow-hidden relative">
                        ...
                        <!-- Date overlay -->
                        <span
                            class="text-xs text-white bg-AccentRed900 px-4 py-2 rounded absolute top-5 left-5 z-20">{{$item->tanggal}}
                            {{$item->bulan}} {{$item->tahun}}</span>
                        <div class="p-6">
