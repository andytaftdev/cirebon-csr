...
<div class="w-full min-h-screen flex flex-col relative bg-white">
    <img src="{{ asset('images/squares.png') }}" alt="squares" class="absolute top-[400px] right-0 h-36 w-36">
    {{-- Tentang Header --}}
    <div class="w-full h-auto flex justify-center items-center relative">
        ...
        <img src="{{ asset('images/background.png') }}" alt="Image Dashboard"
            class="absolute px-10 w-full h-[220px] md:h-[300px] object-cover z-10" style="transform: translateX(-50%); left: 50%;">
    ...
    <div class="relative py-12 px-8 md:px-16 lg:px-32 bg-white flex xl:flex-row flex-col-reverse">
        ...
        <div class="xl:w-[54%] w-full relative flex flex-col">
            <img src="{{ asset('images/tujuan1.png') }}" alt="tujuan"
                class="xl:block hidden absolute top-12 left-10 w-56 h-36">
            <img src="{{ asset('images/tujuan2.png') }}" alt="tujuan"
                class="shadow-lg xl:absolute xl:top-7 xl:right-10 xl:m-0 m-5 h-52 w-80">
            <img src="{{ asset('images/tujuan3.png') }}" alt="tujuan"
                class="xl:block hidden shadow-lg absolute -bottom-20 -left-14 h-52 w-80">
        </div>
    ...
    {{-- Manfaat Section --}}
    <div class="py-16 px-8 md:px-16 lg:px-32 bg-white flex flex-col lg:flex-row items-center">
    ...
    <section class="relative py-16 px-8 lg:px-24 bg-white">
        ...
        <div class="container mx-auto">
            <div class="flex flex-col justify-center items-center">
                ...
                <h1 class="text-Ebony900 lg:text-4xl text-3xl font-bold mt-4 max-w-80 text-center">Laporan Program Terbaru</h1>
            </div>
            ...
            <button class="bg-white hover:bg-neutral-100 border border-Neutral300 font-semibold rounded-lg text-Ebony200 px-4 py-2 flex justify-center items-center my-7 mx-auto">Lihat semua laporan program</button>
    </section>
    ...
    {{-- Panduan Section --}}
    <section class="relative py-24 px-8 lg:px-24 bg-Gray900">
        <img src="{{ asset('images/squares-5.png') }}" alt="squares-2" class="absolute bottom-0 right-0 h-36">
        ...
        <div class="flex flex-col relative justify-center items-center w-full">
            ...
            <div class="flex lg:flex-col sm:flex-row flex-col relative justify-center items-center sm:items-stretch lg:items-center w-full">
                <div class="flex lg:flex-row flex-col lg:px-0 sm:pl-20 w-[90%] sm:w-auto lg:w-2/3 justify-around lg:justify-between items-center z-10 sm:space-y-0 space-y-10">
                    <div class="flex flex-col items-center text-center justify-center font-semibold">
                        ...
                        <p class="text-white text-sm sm:hidden block">Pihak penerima menyerahkan proposal terkait CSR kepada Perusahaan yang akan di tuju.Jika perusahaan meminta rekomendasi Bupati Cirebon maka pihak penerima perlu membuat surat permohonan penerbitan surat rekomendasi CSR kepada Bupati dengan melampirkan dokumen proposal kegiatan.</p>
                    </div>
                    <div class="flex flex-col items-center text-center justify-center font-semibold">
                        ...
                        <p class="text-white text-sm sm:hidden block">Permohonan penerbitan surat rekomendasi CSR yang sudah masuk akan di disposisikan kepada Bagian Perekonomian dan SDA untuk di tindak lanjuti.Setelah Surat rekomendasi CSR di tandatangani Bupati maka pihak penerima perlu mengambil surat tersebut dan menyerahkan nya kepada perusahaan.</p>
                        <span class="text-white mt-1 font-semibold text-base sm:hidden block">Permohonan Penerbitan Surat CSR</span> 
                    </div>
                    <div class="flex flex-col items-center text-center justify-center font-semibold">
                ...
                <div class="flex lg:flex-row flex-col w-[96%] items-start justify-around lg:justify-between">
                    ...
                    <div class="flex flex-col lg:items-center text-left lg:text-center justify-center py-4 px-9">
                        ...
                        <span class="text-white mt-1 font-semibold text-base sm:block hidden">Permohonan Penerbitan Surat CSR</span> 
                    </div>
    
                    <div class="flex flex-col lg:items-center text-left lg:text-center justify-center py-4 px-9">
                        <p class="text-white font-semibold sm:block hidden">Laporan CSR</p>
                        <p class="text-white text-sm sm:block hidden">Setelah perusahaan menerima surat rekomendasi CSR maka selanjutnya pihak perusahaan berhubungan langsung dengan pihak penerima tanpa ada intervensi dari pemda, di akhir tahun berjalan perusahaan yang mengeluarkan CSR perlu melaporkan penyaluran CSR tersebut kepada Pemda sebagai laporan kepada Bupati.</p>
                    </div>
                </div>
            </div>
