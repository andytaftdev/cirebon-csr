...
<div class="w-full min-h-screen flex flex-col relative">
    <div class="w-full h-auto flex justify-center items-center relative">
        ...
        <div class="absolute w-3/4 mx-auto inset-0 flex flex-col items-start justify-center text-start z-20 p-5 lg:p-0">
            <p class="text-white text-sm md:text-base"><span class="text-OrangeS">Beranda / Kegiatan</span> / Detail</p>
            <h1 class="text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl max-w-screen-lg font-bold mt-3">{{$kegiatan->judul}}</h1>
            <p class="text-gray-300 mt-3 text-sm md:text-base lg:my-4">{{$kegiatan->month}} {{$kegiatan->day}} {{$kegiatan->year}}</p>
        </div>
    </div>
